...
const ProductExpert = () => {
  ...
  const questions = [
    {
      question: "What is the primary advantage of powder coating over liquid paint?",
      answers: [
    ...
    {
      question: "When a customer asks about VOC emissions, what is most important to emphasize?",
      answers: [
        "Industry regulations and compliance",
        "Near-zero VOC emissions with powder coating",
        "Comparison with competitor products",
        "Cost savings from reduced ventilation needs"
      ]
    },
    {
      question: "What's the recommended approach when discussing technical specifications?",
      answers: [
        "Provide all technical data upfront",
        "Focus only on specs that competitors can't match",
        "Tailor specifications to the customer's specific application needs",
        "Emphasize industry certifications first"
      ]
    },
    {
      question: "How should you handle questions about specifications you're unsure about?",
      answers: [
        "Provide your best estimate",
        "Redirect to another topic",
        "Acknowledge the gap and commit to providing accurate information",
        "Reference general industry standards"
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[url('/images/Product-Expert.png')] bg-cover bg-center relative">
      {/* Header */}
      ...
      <div className="relative w-full max-w-[655px] mx-auto px-[13px] pb-[50px]">
        {/* Main Card */}
        <div
          className={`relative rounded-[20px] p-4 md:p-[14px] lg:p-9 backdrop-blur-lg ${
            isDark
            ? "bg-[#131313]"
            : "bg-[#FFFFFF]/90"
        }`}
        >
          ...
          <button
            onClick={handleBack}
            className="absolute top-[9px] left-[18px] z-10"
            aria-label="Go back"
          >
          ...
          {/* Assessment Header */}
          <div className="mb-6 md:mb-8 mt-[46px] md:mt-4">
            <p
            ...
            <h1
              className={`text-[26px] md:text-[38px] font-semibold mb-[12px] text-center ${
                isDark ? "text-white" : "text-[#242424]"
              }`}
            >
              Product Expert Assessment
            </h1>
            <p
              className={`text-[18px] md:text-[22px] text-center max-w-[450px] mx-auto ${
                isDark ? "text-[#CECECE]" : "text-[#757575]"
              }`}
            >
          ...
          <div className="mb-6 md:mb-8">
            <div className="flex items-center justify-between mb-2 gap-[12px] flex-col md:flex-row">
                <div
                    className={`w-full h-1.5 md:h-2 rounded-full overflow-hidden order-2 md:order-1 ${
                        isDark ? "bg-[#908471]" : "bg-[#908471]"
                    }`}
                    >
                    <div
              ...
              <div
                className={`text-[12px] font-medium whitespace-nowrap order-1 md:order-2 ${
                  isDark ? "text-[#CECECE]" : "text-[#757575]"
                }`}
              >
          ...
          {/* Question Section */}
          <div 
                className={`p-[18px] pb-[26px] md:p-[24px] rounded-[12px] md:rounded-[20px] mb-[30px] md:mb-[48px] ${
                    isDark ? "bg-[#232323]" : "bg-[#DCD6CE]"
                }`}
            >
            <div className="mb-[8px] md:mb-[28px]">
                <p
                    className={`text-[10px] md:text-[14px] font-medium uppercase tracking-[0.5px] mb-[5px] ${
                        isDark ? "text-[#CECECE]" : "text-[#757575]"
                    }`}
                >
                ...
                <h2
                className={`text-[16px] md:text-[22px] font-semibold leading-tight mb-0 ${
                    isDark ? "text-white" : "text-[#242424]"
                }`}
                >
                {question}
            ...
            <div className="space-y-2.5 md:space-y-3">
                ...
                >
                    <div className="flex items-center gap-[8px]">
                        ...
                        <span
                            className={`flex-1 text-[10px] md:text-[14px] leading-[15px] ${
