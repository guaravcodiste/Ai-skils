            ...
            <div className={`min-h-screen flex flex-col transition-colors duration-300 ${isDark ? 'bg-[#131313]' : 'bg-[#EAEAEA]'}`}>
                <div className="max-w-[1440px] mx-auto flex flex-col flex-1 w-full">
                    ...
                    <div className="p-[16px] md:p-[26px] pt-0 md:pt-0 flex-1">
                        <div
                            className={`rounded-[20px] border backdrop-blur-lg mb-[22px] md:mb-[12px] p-[24px] md:p-[20px] flex justify-between items-center flex-col md:flex-row ${isDark ? 'bg-[#1b1b1b] border-[#ffffff1a]' : 'bg-white border-[#EEEEEE]'
                                }`}
                        >
                            <div className="mb-[22px] md:mb-0">
                                <h1
                                    className={`text-[28px] font-semibold mb-[12px] md:mb-0 text-center md:text-left leading-[38px] ${isDark ? 'text-white' : 'text-[#000000]'
                                        }`}
                                >
                            ...
                            <div className="flex gap-[18px] md:gap-[14px] items-center flex-wrap justify-center">
                                <div
                                    className={`flex-1 px-[34px] md:px-[34px] py-3 md:py-[8px] rounded-full border transition-all duration-300 ${isInWarningZone ? 'border-[#F59E0B] bg-[#F59E0B] timer-pulse' : 'border-[#DCD6CE] bg-[#908471]'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 md:px-[34px] py-3 md:py-[8px] rounded-full border border-[#FF0000] bg-[#930A0A] whitespace-nowrap flex items-center gap-2 text-[14px] md:text-[12px] text-white text-center ${!isSessionActive ? 'opacity-50 cursor-not-allowed' : ''
                                        }`}
                                >
                                    <StopIcon />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-4 gap-[10px] md:gap-[14px] lg:items-stretch">
                                        ...
                                        <>
                                            <div className="absolute bottom-2 md:bottom-2 right-0 left-0 z-20 flex items-center justify-center gap-2 md:gap-4">
                                                <button
                                                    ...
                                                    className={`w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all ${isMicEnabled ? 'bg-[#FEF3C7]' : 'bg-white/20 backdrop-blur-sm'
                                                        }`}
                                                >
                                                    <MicrophoneIcon />
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    disabled={!isSessionActive}
                                                    className={`w-8 h-8 md:w-12 md:h-12 rounded-full bg-[#FF6B35] flex items-center justify-center transition-all hover:opacity-80 ${!isSessionActive ? 'opacity-50 cursor-not-allowed' : ''
                                                        }`}
                                                >
                                            ...
                                            <div className="absolute bottom-2 md:bottom-2 right-2 md:right-2 z-20">
                                                <div className="relative inline-flex rounded-full overflow-hidden bg-[#000000cc] p-0.5 md:p-1">
                                                    <button
                                                        ...
                                                        className={`px-3 py-1 md:px-5 md:py-2 font-bold text-xs md:text-base text-white transition-all duration-200 rounded-full ${inputMode === 'voice' ? 'bg-[#CAD3AC]' : ''
                                                            }`}
                                                    >
                                                        Voice
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`px-3 py-1 md:px-5 md:py-2 font-bold text-xs md:text-base text-white transition-all duration-200 rounded-full ${inputMode === 'text' ? 'bg-[#CAD3AC]' : ''
                                                            }`}
                                                    >
                                                        Text
                                                    </button>
                            ...
                            <div className="lg:col-span-2 xl:col-span-1 flex flex-col space-y-[12px] h-full min-h-0">
                                <div
                                    className={`rounded-[12px] md:rounded-[20px] border p-4 md:p-6 flex flex-col flex-1 min-h-0 overflow-hidden ${isDark ? 'bg-[#1b1b1b] border-[#ffffff1a]' : 'bg-white border-[#EEEEEE]'
                                        }`}
                                >
                                        ...
                                        {chatMessages.length === 0 ? (
                                            <div className="flex items-start gap-[6px]">
                                                <div className="flex-1">
                                                    ...
                                                    <div
                                                        className={`text-[12px] leading-relaxed rounded-[12px] p-[6px] ${isDark ? 'text-[#ffffff] bg-[#131313]' : 'text-[#475569] bg-[#F8FAFC]'
                                                            }`}
                                                    >
                                ...
                                <div className="relative flex-shrink-0">
                                    <input
                                        ...
                                        className={`w-full px-4 md:px-6 py-3 md:py-4 rounded-full border text-[12px] ${isDark
                                            ? 'bg-[#1b1b1b] border-[#ffffff1a] text-white placeholder-[#757575]'
                                            : 'bg-white border-[#EEEEEE] text-[#475569] placeholder-[#757575]'
                                            } focus:outline-none focus:ring-2 focus:ring-[#908371] pr-24 md:pr-28 ${!isSessionActive || isSendingMessage ? 'opacity-50 cursor-not-allowed' : ''
                                            } `}
                                    />
                                    <div className="absolute right-3 md:right-4 top-1/2 transform -translate-y-1/2 flex items-center gap-2 md:gap-3">
                                        ...
                                        <button
                                            ...
                                            className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity ${isDark ? 'bg-white' : 'bg-black'
